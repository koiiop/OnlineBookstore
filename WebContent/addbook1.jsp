...
<p align="center">
<form name="book" onsubmit="return yanzheng()" action="addbook.jsp" method="post">
...
<tr><td colspan="2" align="center"><input type="submit" value="提交" ><input type="reset" value="重置">                    
</table>
</form>
